...
public class GameStage implements IGameStage
{
    ...
    private void createRooms()
    {
        ...
        var usaItem = new Item("Jade Dragon", Countries.China, 2, Countries.Japan, -2, "jadeDragon.png");
        ...
        var chinaItem = new Item("Vodka", Countries.Russia,2, Countries.India,-2, "vodka.png");
        ...
        var germanyItem = new Item("Flute", Countries.India,2, Countries.USA,-2, "flute.png");
        //var germanyItem2 = new Item("Matrojska", Countries.Russia,3, Countries.India,-2, "matrojska.png");
        ...
        var russiaItem = new Item("Katana", Countries.Japan,2, Countries.China,-2, "katana.png");
        //var russiaItem = new Item("Panda", Countries.China,2, Countries.Germany,-1, "panda.png");
        ...
        var indiaItem = new Item("Sausage", Countries.Germany,3, Countries.Russia,-1, "sausage.png");
        ...
        var japanItem = new Item("Gun", Countries.USA,2, Countries.Japan,-2, "gun.png");
        //var japanItem = new Item("Cheeseburger", Countries.USA,1, Countries.China,-1, "cheeseburger.png");
        //var japanItem = new Item("Pretzel", Countries.Germany,2, Countries.USA,-2, "pretzel.png");
