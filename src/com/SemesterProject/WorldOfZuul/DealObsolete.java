...
class DealObsolete {
    ...
    private DealCategoryObsolete category; //Catogery of deals
    ...
    public DealObsolete(String name, DealCategoryObsolete category, int sustainabilityPoints,
     ...
     * @return category
     */
    public DealCategoryObsolete getCategory()
    {
        return category;
    }
    /**
